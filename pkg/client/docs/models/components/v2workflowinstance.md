...
| `Status`                                                               | [][components.V2StageStatus](../../models/components/v2stagestatus.md) | :heavy_minus_sign:                                                     | Per-stage progress of the run                                          |
...
| `Workflow`                                                             | [*components.V2Workflow](../../models/components/v2workflow.md)        | :heavy_minus_sign:                                                     | A workflow definition and the stages it runs                           |